...
const NewCategory = () => {
    ...
    const formSubmit = async (e) => {
        ...
        try {
            await axios.post(`https://mernfa-fileshop-server.iran.liara.run/api/category/new-category`,formData);
            toast.success("دسته محصول با موفقیت ذخیره شد.",{position: "top-right",autoClose: 5000,rtl: true,className: 'toast-message'})
        } catch (error) {
            toast.error(error.response?.data?.msg ? error.response.data.msg : "خطا در ذخیره دسته محصول",{position: "top-right",autoClose: 5000,rtl: true,className: 'toast-message'})
        }
    ...
    return ( 
        <div className="flex flex-col gap-6">
            <h2 className="text-orange-500 text-xl">دسته جدید</h2>
