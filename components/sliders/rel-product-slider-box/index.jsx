...
const SlideBox = ({ _id , title, slug, image, imageAlt, price, categories }) => {
  ...
  return (
    <article className="sliderItem w-full min-w-[100%] lg:w-1/2 lg:min-w-[50%] px-2 2xl:w-1/3 2xl:min-w-[33.33%]">
      <div className="h-[31rem] sm:h-[32rem] lg:h-[30rem] xl:h-[28rem] w-full min-w-[275px] bg-white relative px-2 py-3 rounded-xl shadow-[1px_1px_4px_rgba(0,0,0,0.25)] transition-all duration-300 hover:-translate-y-1">
