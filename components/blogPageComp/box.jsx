...
const Box = ({title,slug,image,imageAlt,shortDesc,pageView,updatedAt}) => {
    return ( 
        <article className="relative mb-4">
            <Link target="_blank" href={`/blog/${slug}`}>
                <div className="w-[17rem] px-2 pt-2 pb-3 bg-white rounded-xl shadow-[0px_1px_8px_rgba(0,0,0,0.25)] transition-all duration-300 hover:-translate-y-1">
                    <div>
                        <Image
                            width={440}
                            height={160}
